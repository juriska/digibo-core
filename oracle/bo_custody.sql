...
create or replace package BOCustody as
...
create or replace package body BOCustody as
...
begin
	...
	where p.id = docId
		and p.class_id in ( 318, 319, 320, 323, 327, 330)
...
begin
	...
	where rownum <= bocommon.ResultSetSize and
		p.class_id in ( 318, 319, 320, 323, 327, 330) and (
